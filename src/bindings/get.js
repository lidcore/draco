...
var Tmp$LidcoreDraco = require("./tmp.js");
...
function to_tmp(failOnClientError, headers, prefix, postfix, tmp, url) {
  return BsAsyncMonad.Callback[/* >> */3](stream(failOnClientError, headers, url), (function (resp) {
                var partial_arg = resp.data;
                return BsAsyncMonad.Callback[/* >> */3]((function (param) {
                              return Tmp$LidcoreDraco.to_tmp(prefix, postfix, tmp, partial_arg, param);
                            }), (function (tmp) {
                              var partial_arg = {
                                statusCode: resp.statusCode,
                                data: tmp
