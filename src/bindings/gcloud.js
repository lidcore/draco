...
function init($staropt$star, param) {
  return new Pubsub($staropt$star !== undefined ? Caml_option.valFromOption($staropt$star) : default_config);
}
...
function topic(pubsub, name) {
  ...
  return BsAsyncMonad.Callback[/* >> */3]((function (param) {
                ...
                return BsAsyncMonad.Callback[/* >| */7](tmp, (function (param) {
                              return t;
                            }));
              }));
}
...
function init$1($staropt$star, param) {
  return new Compute($staropt$star !== undefined ? Caml_option.valFromOption($staropt$star) : default_config);
}
...
function init$2($staropt$star, param) {
  return new Firestore($staropt$star !== undefined ? Caml_option.valFromOption($staropt$star) : default_config);
}
...
function process_snapshot(ref, snapshot) {
  if (snapshot.exists) {
    var partial_arg_001 = Caml_option.some(snapshot.data());
...
function save(param, data) {
  ...
  return BsAsyncMonad.Callback[/* >> */3]((function (param) {
                ...
                var partial_arg_001 = Caml_option.some(data);
                var partial_arg = /* tuple */[
                  ref,
                  partial_arg_001
                ];
...
function get(param, key) {
  var data = param[1];
  if (data !== undefined) {
    return Js_null_undefined.fromOption(Js_dict.get(Caml_option.valFromOption(data), key));
  } else {
    return null;
  }
}
...
function incr(param) {
  var path = param[1];
  return runTransaction(Caml_option.some(options), param[0], (function (tr) {
...
function $$delete$2(param) {
  return BsAsyncMonad.Callback[/* >> */3]($$document(param[0], param[1]), (function (doc) {
                return BsAsyncMonad.Callback[/* >| */7]($$delete(doc), (function (prim) {
                              return /* () */0;
                            }));
              }));
}
...
function latest_cleanup(db) {
  return BsAsyncMonad.Callback[/* >| */7]($$document(db, "admin/latest_cleanup"), (function (doc) {
                try {
                  var doc$1 = saved(doc);
                  return Caml_option.some(get(doc$1, "timestamp"));
                }
                catch (exn){
                  if (exn === Not_saved) {
                    return undefined;
...
function init$3($staropt$star, param) {
  var config = $staropt$star !== undefined ? Caml_option.valFromOption($staropt$star) : default_config;
