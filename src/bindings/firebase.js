...
function loadFunctions (){require("firebase-functions")};

function initApp (){require("firebase-admin").initializeApp()};
...
function https (){return require("firebase-functions").https};

function from_express(app) {
  return https().onRequest(app);
}

function pubsub (){return require("firebase-functions").pubsub};
