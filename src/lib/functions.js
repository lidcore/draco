...
function query(req) {
  var partial_arg = Express$LidcoreBsExpress.Request[/* query */3](req);
...
function add_route(meth, $staropt$star, app, route, handler) {
  ...
  return Curry._3(match[1], app, route, (function (req, resp) {
                var url = Express$LidcoreBsExpress.Request[/* originalUrl */4](req);
                ...
                return (function (param) {
                            ...
                            return Curry._1(handler, (function (err, ret) {
                              ...
                              if (err == null) {
                                ...
                                Express$LidcoreBsExpress.Response[/* send */5](Express$LidcoreBsExpress.Response[/* headers */7](Express$LidcoreBsExpress.Response[/* status */8](resp$1, code), headers), body);
                                return /* () */0;
                              } else {
                                throw [
